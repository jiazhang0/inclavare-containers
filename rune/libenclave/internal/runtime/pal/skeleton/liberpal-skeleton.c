...
int __pal_get_local_report(uint64_t base, void *targetinfo,
			   int targetinfo_len, void *report, int *report_len)
{
	...
	ret = SGX_ENTER_3_ARGS(ECALL_REPORT, (void *) base, targetinfo,
